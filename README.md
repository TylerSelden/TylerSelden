...
- [SwiftBid](https://github.com/TylerSelden/swiftbid): A dockerized auction website for fundraisers.
- [T-Minus](https://github.com/TylerSelden/tminus1): hehehe...
- [Gaggle](https://github.com/TylerSelden/gaggle): A headless, browser-based remote desktop system, build on Docker.
- [JS Raycaster](https://github.com/TylerSelden?tab=repositories): A simple raycasting engine written in Javascript, since I like to play around with 3D graphics.
